...
calibrated_source: isotonic+stpasa     # "isotonic+stpasa" (h22–h120), "isotonic", "isotonic_below_domain" (raw forecast below every forecast the bucket was fitted on, published as the raw value shifted by the correction at the domain edge), "passthrough_high", "passthrough_sanity", or "passthrough"
